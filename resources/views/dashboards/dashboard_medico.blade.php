<div class="dashboard-wrapper column padding_orizontal_20 padding_vertical_20 min_height gap_40 full_width">
    ...
    <div class="dash-header row between vertical_center">
        ...
        <div class="row gap_15 vertical_center" style="flex-wrap: wrap;">
            <a href="{{ route('medicines.index') }}" class="btn secondary" style="text-decoration: none;">Gestione Farmaci</a>
            <a href="{{ route('prescriptions.index') }}" class="btn primary" style="text-decoration: none;">Gestione Prescrizioni</a>
    ...
    @if($pazienti->isEmpty())
        ...
        <div class="section-block box column vertical_center text_center gap_20 padding_orizontal_20 padding_vertical_20"
            ...
            <p style="opacity: 0.6; max-width: 400px; margin: 0 auto;">
                Non hai ancora pazienti collegati al tuo account. I pazienti si assegnano autonomamente dalla loro pagina profilo.
            </p>
        </div>
    @else
        {{-- Selezione paziente --}}
        <div class="section-block box row between vertical_center gap_20 padding_orizontal_20 padding_vertical_15">
            ...
            <select id="paziente-select" class="paziente-select font_normal" style="background: var(--background-color1); border: 2px solid currentColor; border-radius: 10px; padding: 8px 15px; font-size: 1rem; cursor: pointer; flex: 1;">
